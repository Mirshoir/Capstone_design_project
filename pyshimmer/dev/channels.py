...
class ChannelDataType:
    ...
    of single such channel, and is capable of decoding binary data into the appropriate form.
    """
...
class EChannelType(Enum):
    """
    Represents the content type of  single data channel recorded by a Shimmer device
    """
    ACCEL_LN_X = auto()
    ACCEL_LN_Y = auto()
    ACCEL_LN_Z = auto()
